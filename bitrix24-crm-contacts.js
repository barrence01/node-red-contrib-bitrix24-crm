module.exports = function(RED) {
    function Bitrix24CrmContacts(config) {
        ...
        import('@2bad/bitrix').then(({ Bitrix }) => {
            ...
            node.on('input', (msg, send, done) => {
                ...
                bitrix_webhook.contacts = Bitrix(webhook).contacts; // Reinitialize with updated webhook
            ...
            function add(msg, send, done) {
                ...
                bitrix_webhook.contacts.create(msg.fields, msg.params)
                    .then(({ result }) => {
                        node.warn('Contact created successfully with ID:', result);
                        msg['payload'] = result;
                        node.send(msg);
                        done();
                    })
                    .catch(err => {
                        node.error("Failed to create contact: " + err.message);
                        done(err);
                    });
            }
            ...
            function update(msg, send, done) {
                ...
                bitrix_webhook.contacts.update(msg.id, msg.fields, msg.params)
                    .then(({ result }) => {
                        msg['payload'] = result;
                        node.send(msg);
                        done();
                    ...
                    .catch(err => {
                        node.error("Failed to update contact: " + err.message);
                        done(err);
                    });
            }
            ...
            function get(msg, send, done) {
                ...
                bitrix_webhook.contacts.get(msg.id)
                    .then(({ result }) => {
                        msg['payload'] = result;
                        node.send(msg);
                        done();
                    ...
                    .catch(err => {
                        node.error("Failed to get contact: " + err.message);
                        done(err);
                    });
            }
            ...
            function list(msg, send, done) {
                ...
                bitrix_webhook.contacts.list(msg.select)
                    .then(({ result }) => {
                        msg['payload'] = result;
                        node.send(msg);
                        done();
                    ...
                    .catch(err => {
                        node.error("Failed to list contacts: " + err.message);
                        done(err);
                    });
            }
            ...
            function fields(msg, send, done) {
                ...
                bitrix_webhook.contacts.fields()
                    .then(({ result }) => {
                        msg['payload'] = result;
                        node.send(msg);
                        done();
    ...
    RED.nodes.registerType("bitrix24-crm-contacts", Bitrix24CrmContacts);
};
